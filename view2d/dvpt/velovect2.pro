...
;+ 
; NAME:
;	VELOVECT2 ; modified from library subroutine VELOVECT found in
;	hercules.oma.be:/usr/local/rsi/idl_4/lib/velovect.pro
;
; PURPOSE:
...
;	August, 1993. DMS, Added _EXTRA keyword inheritance for PLOT.
...
;       November, 1996. S. Chabrillat, Belgium Institute for Space Aeronomy,
;		removed the _EXTRA inheritance for PLOTS and OPLOT.
;		Simplified the call to PLOT
;-
;
...
;
	...
	y_b0=y0-y_step
	y_b1=y1+y_step
        plot, [x_b0,x_b1], [y_b1,y_b0], /NODATA, _EXTRA = extra
;
