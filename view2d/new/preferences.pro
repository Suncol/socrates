...
arch_path1 = '/home/simonc/socrates/arch/'

; OPTIONAL: Set this string to a less usual (often NFS-mounted drives) path
; to your input NetCDF (*.nc) files.
; If useless to you, set this to '' (null string)
arch_path2 = '/unicos_tmp/simonc/netcdf/'
