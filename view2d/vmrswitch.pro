...
If (zl.units eq 'molec/cm3') then Begin
   ...
   EndIf
EndIf
If (last.plot2d eq 'depth-x') and (zmolat.units eq 'molec/cm3') then Begin
   zmolat.units = 'vmr'
   ...
   EndIf
 EndIf Else If (last.plot2d eq 'depth-y') and (zmolev.units eq 'molec/cm3') then Begin
   zmolev.units = 'vmr'
