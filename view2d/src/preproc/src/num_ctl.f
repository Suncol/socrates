! subversion Id for THIS file : $Id: num_ctl.f 8506 2016-01-28 10:09:58Z simonc $
! $URL: http://svn-ae/ae/COMMON/stand-alone/atmos_models/socrates/tags/07.18.01/src/preproc/src/num_ctl.f $
!-----------------------------------------------------------------------
...
!	... Dummy arguments
!-----------------------------------------------------------------------
      integer, intent(out) ::      iter_counts(4)          ! iteration counts
