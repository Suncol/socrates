! subversion Id for THIS file : $Id: sparse_pat.f 8506 2016-01-28 10:09:58Z simonc $
! $URL: http://svn-ae/ae/COMMON/stand-alone/atmos_models/socrates/tags/07.18.01/src/preproc/src/sparse_pat.f $
!-----------------------------------------------------------------------
...
!-----------------------------------------------------------------------
	 kl = cls_rxt_cnt(1) + 1
	 do k = kl,ku
            pmask(k,:) = cls_rxt_map(k,4:7) == species
